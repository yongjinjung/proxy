...
public class DynamicProxyBasicConfig {
    ...
    public OrderRepositoryV1 orderRepositoryV1(LogTrace logTrace) throws Exception{
        ...
        LogTraceBasicHandler target = new LogTraceBasicHandler(orderRepositoryV1, logTrace);
    ...
    public OrderServiceV1 orderServiceV1(LogTrace logTrace) throws  Exception{
        ...
        LogTraceBasicHandler target = new LogTraceBasicHandler(orderServiceV1, logTrace);
    ...
    public OrderControllerV1 orderControllerV1(LogTrace logTrace) throws Exception{
        ...
        LogTraceBasicHandler target = new LogTraceBasicHandler(orderControllerV1, logTrace);
